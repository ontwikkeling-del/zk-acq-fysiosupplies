        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            >
              ...
              <p className="text-brand-green font-black text-4xl md:text-5xl mb-2">€2M+</p>
              <p className="text-gray-400 text-sm uppercase tracking-wider">Per maand bereikt</p>
            </motion.div>
          </div>
          ...
          >
            <div className="w-48 h-48 md:w-56 md:h-56 rounded-full overflow-hidden border-4 border-brand-purple/10 shadow-lg">
              <img src="https://zwartekraai.nl/assets/erwin-dijkstra-new-CBI4auj_.jpg" alt="Erwin Dijkstra" className="w-full h-full object-cover" />
            </div>
            <div className="text-center">
              <p className="text-brand-purple font-bold text-xl">Erwin Dijkstra</p>
              <p className="text-gray-400 text-sm">CEO & Strategie</p>
            </div>
          </motion.div>
        </div>
      </div>
